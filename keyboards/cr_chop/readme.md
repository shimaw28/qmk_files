# Corne Keyboard (cr_chop)

Also known (incorrectly) as the `HeliDox`. 

![cr_chop](https://user-images.githubusercontent.com/736191/40575636-6fba63a4-6123-11e8-9ca0-3f990f1f9f4c.jpg)

![cr_chop](https://user-images.githubusercontent.com/736191/40887871-0eead5dc-678a-11e8-9518-e3ad9e5d2bac.png)

A split keyboard with 3x6 vertically staggered keys and 3 thumb keys.

Keyboard Maintainer: [foostan](https://github.com/foostan/) [@foostan](https://twitter.com/foostan)  
Hardware Supported: cr_chop PCB, Pro Micro  
Hardware Availability: [PCB & Case Data](https://github.com/foostan/cr_chop)

Make example for this keyboard (after setting up your build environment):

```sh
make cr_chop:default
```
...
```sh
make cr_chop:default RGB_MATRIX_SPLIT_RIGHT=yes
```
