...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LCTL,  KC_B,  KC_S,  KC_D,  KC_F,  KC_G,                   KC_H,  KC_J,  KC_K,  KC_L,KC_SCLN,KC_QUOT,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LSFT,  KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,                   KC_N,  KC_M,KC_COMM,KC_DOT,KC_SLSH,KC_RSFT,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
    KC_A,     KC_B,              KC_LGUI, LOWER,KC_SPC,   KC_ENT, RAISE,KC_RALT,              KC_C, KC_D\
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
    KC_E,    KC_F                KC_LGUI, LOWER,KC_SPC,   KC_ENT, RAISE,KC_RALT,             KC_G, KC_H \
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
    KC_I,   KC_J                 KC_LGUI, LOWER,KC_SPC,   KC_ENT, RAISE,KC_RALT,              KC_K, KC_L\
                              //`--------------------'  `--------------------'
  ),
