...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, EISU,    LOWER,   LSFT_T(KC_SPC),  LSFT_T(KC_SPC),  RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      VIMMOVE, RESET,   RGBRST,  _______, _______, _______,                   _______, _______, _______, _______, _______, KC_DEL, \
  ...
  [_VIMMOVE] =  LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                   _______, _______, QWERTY,  _______, _______, _______, \
